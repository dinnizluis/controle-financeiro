...
1. A GitHub Issue and a versioned Spec Kit artifact under `specs/` exist and reference each other.
2. `spec.md` has reviewed acceptance scenarios, business rules, edge cases, data impact, and scope.
