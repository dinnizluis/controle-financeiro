...
| Duplicate weekly check-ins keep history and switch current row | weekly check-in persistence rules in [src/controle_financeiro/storage.py](../../src/controle_financeiro/storage.py) | `test_duplicate_weekly_checkin_keeps_history_and_switches_current` in [tests/test_spec001_contract.py](../../tests/test_spec001_contract.py) | Covered |  |
